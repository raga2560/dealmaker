...
gulp.task('scripts', function() {
  ...
  gulp.src(['misc/**']).pipe(gulp.dest(path.join(targetDir, 'misc')));
  ...
  var scriptStream = gulp
    .src(['templates.js', 'app.js', '**/*.js', '**/events/*.js'], { cwd: 'app/scripts' })
...
gulp.task('templates', function() {
  return gulp.src(['app/templates/**/*.*', 'app/scripts/events/*.html'])
